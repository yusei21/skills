...
1. Check the source's license before copying:
   - **MIT / Apache-2.0 / BSD:** safe, mix freely
   - **GPL / AGPL:** careful — may require this whole repository to
     become GPL too
   - **No declared license:** don't copy without explicit permission
2. Copy the content into the matching folder here
   (`agents/`, `skills/`, `rules/`, etc.)
3. Add a new section to [`NOTICE.md`](../NOTICE.md) and
   [`NOTICE.en.md`](../NOTICE.en.md), filling in source, copyright,
   license, and what was kept/adapted/removed
